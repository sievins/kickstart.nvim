---@class sievins.bufdelete
---@overload fun(buf?: number|sievins.bufdelete.Opts)
...
--- Delete all buffers
---@param opts? sievins.bufdelete.Opts
function M.all(opts)
